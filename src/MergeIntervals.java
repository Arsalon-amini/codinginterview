...
public class MergeIntervals {
    ...
    public static int[][] mergeOverlappingIntervals(int[][] intervals) {
        ...
        int [] currentInterval = sortedIntervals[0]; //create reference to current interval (first)
        mergedIntervals.add(currentInterval); //append current interval to output (first)
